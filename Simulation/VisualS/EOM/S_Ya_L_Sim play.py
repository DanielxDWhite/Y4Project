...
print(np.sum(Jsum))
STR = '{}mW [{}] \n{}MHz =RF \n{}MHz =AOM \n{} =Beta [{}]\n{}% Captured\n[{}/{}]\n    {} {}s' 
iSTR = STR.format(P*1000, round(E0), RF/1000000, (AOM)/1000000, Beta,  round(np.sum(Jsum),4), round(N0*100/Natoms,3), N0,Natoms,d4,round(stop - start, 3))
...
BinFactor = 10
Bins = np.linspace(0,1.5*z0,int(Natoms/BinFactor))  # Bins # Bins # Bins # Bins # Bins # Bins # Bins # Bins # Bins #
print(Bins)
