...
ax2.set_ylim(top=2*aa, bottom=-0.05)
...
ax3.set_ylabel("Speed / ms`'", size = 15)
#ax3.set_title('Multi-Frequency Slowing Simulation: $\it{7}$ $\it{Frequencies}$, $\it{MOT}$ $\it{Magnetic}$ $\it{Field}$', size=17)
ax3.set_title('Multi-Frequency Slowing Simulation: 7 Frequencies and MOT Magnetic Field', size=17)
ax4.set_xlabel('Distance / m (0 = atom source)', size = 15)
